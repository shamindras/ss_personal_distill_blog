...
theory/methodology research`, `rstats`, `python` etc) as well as anything else
I am generally into e.g. books, sports.
...
the bootstrap in our Skype chats. That will still continue though `r
emo::ji("smile")`
