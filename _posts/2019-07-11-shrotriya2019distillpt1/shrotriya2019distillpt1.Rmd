...
date: 07-11-2019
preview: https://github.com/shamindras/ss_personal_distill_blog/raw/master/_posts/2019-07-11-shrotriya2019distillpt1/images/08_06_netlify_adding_custom_domain.png
...
```{bash step-02-03, eval=FALSE, echo=TRUE, cache=TRUE}
tree
```
