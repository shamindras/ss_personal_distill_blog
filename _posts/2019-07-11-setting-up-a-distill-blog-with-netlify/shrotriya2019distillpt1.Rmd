...
<center>
```{r step-01-01-screenshot, fig.cap="Setting up the Site Github repo", echo=FALSE, out.extra="class=external", out.width="150%", cache=TRUE}
...
<center>
```{r step-01-02-screenshot, fig.cap="New Site Github repo with README.md", echo=FALSE, out.extra="class=external", out.width="150%", cache=TRUE}
knitr::include_graphics(path =
                            fs::path(IMAGES_PATH,
...
<center>
```{r step-05-02-screenshot, fig.cap="Newly Created Distill Blog (local)", echo=FALSE, out.extra="class=external", cache=TRUE}
knitr::include_graphics(path =
                            fs::path(IMAGES_PATH,
...
```{r step-08-01-screenshot, fig.cap="Creating New Site with Netlify", echo=FALSE, out.extra="class=external", out.width="150%", cache=TRUE}
knitr::include_graphics(path =
                            fs::path(IMAGES_PATH,
...
<center>
```{r step-08-02-screenshot, fig.cap="Giving Netlify New Github repo Access", echo=FALSE, out.extra="class=external", out.width="150%", cache=TRUE}
knitr::include_graphics(path =
                            fs::path(IMAGES_PATH,
...
<center>
```{r step-08-03-screenshot, fig.cap="Configuring Netlify Build Options", echo=FALSE, out.extra="class=external", out.width="150%", cache=TRUE}
knitr::include_graphics(path =
                            fs::path(IMAGES_PATH,
...
<center>
```{r step-08-04-screenshot, fig.cap="Default Netlify Site Name", echo=FALSE, out.extra="class=external", out.width="150%", cache=TRUE}
knitr::include_graphics(path =
                            fs::path(IMAGES_PATH,
...
<center>
```{r step-08-05-screenshot, fig.cap="Setup Continuous Deployment with Netlify", echo=FALSE, out.extra="class=external", out.width="150%", cache=TRUE}
knitr::include_graphics(path =
                            fs::path(IMAGES_PATH,
...
<center>
```{r step-08-06-screenshot, fig.cap="Customize Site Domains with Netlify", echo=FALSE, out.extra="class=external", out.width="150%", cache=TRUE}
knitr::include_graphics(path =
                            fs::path(IMAGES_PATH,
...
<center>
```{r step-08-07-screenshot, fig.cap="All Custom Domains for Site with Netlify", echo=FALSE, out.extra="class=external", out.width="150%", cache=TRUE}
knitr::include_graphics(path =
                            fs::path(IMAGES_PATH,
