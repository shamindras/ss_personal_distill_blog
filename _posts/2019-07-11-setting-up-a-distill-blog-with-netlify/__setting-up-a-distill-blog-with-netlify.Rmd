...
description: |
  First part of a series on how I setup this `Distill` theme blog
author:
...
package by the [RStudio](h//www.rstudio.com/) team. The main tools used I used
...
created a [nice distill blog creation
tutorial](https://rstudio.github.io/distill/blog.html) which I thoroughly used
...
[github pages](https://pages.github.com/) down the line if needed.  You can
...
[here](https://github.com/shamindras/ss_personal_distill_blog/blob/master/about.Rmd)
for reference. </aside>
...
There are free alternatives e.g.  [Github Pages](https://pages.github.com/),
...
[netlify](https://www.netlify.com/)! This is a free (and awesome) deployment
...
- Setting up [Disqus](https://disqus.com/) to enable user comments on blogposts
