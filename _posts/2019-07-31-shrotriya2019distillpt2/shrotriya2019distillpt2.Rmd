...
preview: images/hex-distill.png
output:
...
I'd like to thank [Julie Jung](https://www.jungjulie.com/) for creating the 
`distill` hex sticker which is the preview image for this post. This was 
originally sourced from [this post](https://blog.rstudio.com/2020/12/07/distill/#a-hex-sticker).
